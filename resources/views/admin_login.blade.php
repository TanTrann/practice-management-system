...
<![endif]-->
    ...
    <!-- Required Jquery -->
    <script type="text/javascript" src="public/backend/assets/js/jquery/jquery.min.js"></script>
    <script type="text/javascript" src="public/backend/assets/js/jquery-ui/jquery-ui.min.js"></script>
    <script type="text/javascript" src="public/backend/assets/js/popper.js/popper.min.js"></script>
    <script type="text/javascript" src="public/backend/assets/js/bootstrap/js/bootstrap.min.js"></script>
    <!-- jquery slimscroll js -->
    <script type="text/javascript" src="public/backend/assets/js/jquery-slimscroll/jquery.slimscroll.js"></script>
    <!-- modernizr js -->
    <script type="text/javascript" src="public/backend/assets/js/modernizr/modernizr.js"></script>
    <script type="text/javascript" src="public/backend/assets/js/modernizr/css-scrollbars.js"></script>
    <script type="text/javascript" src="public/backend/assets/js/common-pages.js"></script>
</body>
