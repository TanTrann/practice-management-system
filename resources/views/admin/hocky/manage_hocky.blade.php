                                        ...
                                        <table class="table table-hover"  id="mytable" >
                                            ...
                                            <tr>
                                                        @foreach($all_hocky as $key => $val)
                                                            ...
                                                            <td>
                                                                <button class="btn show-edit-hocky" data-toggle="modal" data-target="#showeditschedule"    data-id_hocky="{{$val->hocky_id}}" ><i class="fa fa-pencil " style="color: green;" ></i></button>
                                                            <a href="{{URL::to('/delete-hocky/'.$val->hocky_id)}}"  onclick="return confirm('Bạn có chắc là muốn xóa học kỳ này?')"  >
        ...
        <div class="modal-header">
            ...
            <div class="row">
                <div class="col-sm-11" style="margin-left: 75px;">
                    ...
                    <!-- form nhập tkb -->
                    <form action="{{URL::to('insert-hocky')}}" method="post">
                        @csrf
