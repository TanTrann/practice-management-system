                        ...
                        <table class="table table-striped " style="text-align: center;" id="mytable" >
                            ...
                            @foreach($nhomth as $key => $lophp)
                                <tr>
                                    ...
                                    @foreach($all_nhomth2 as $key => $val_nhom)
                                    ...
                                    <td><button class="btn-xs dkylich"  data-toggle="modal" data-target="#dkilich" data-nhom_id="{{$lophp->nhom_id}}" style="color: green;">Xếp lịch</button></td>
                                    @else
                                    <td style="">
                                    <a href="{{URL::to('/huy-dki-nhom/'.$lophp->nhom_id)}}"  onclick="return confirm('Bạn có chắc là muốn hủy đăng ký nhóm học phần này?')"  >
                                        <button class="btn-xs" style="color: red;">Hủy lịch</button>
                                    </a>
                                    </td>
                                    @endif
                ...
                <div class="col-sm-11" style="margin-left: 35px;">
                    ...
                    <form action="{{URL::to('/dki-phong-th-all-hki')}}" method="post">
                        ...
                        <div class=" "  style="" >
                            ...
                            <div class=""> 
                            <select name="namhoc" id="namhoc_lophp" class="form-control" disabled> 
                        ...
                        <div class=" "  style="" >
                            ...
                            <div class="">
                                <select name="nhom_id" id="nhom_id" class="form-control" disabled>
                        ...
                        <div class=" "  style="" >
                            ...
                            <div class="">
                            <select name="id_thu" id="thu" class="form-control">
                        ...
                        <div class="" style="" >
                            ...
                            <div class="">
                             <select name="id_buoi" id="id_buoi" class="form-control chonbuoi buoi" >
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <select id="gio_bd" name="gio_bd" class="form-control gio_bd  chonbuoi"> 
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <select id="gio_kt" name="gio_kt" class="form-control  gio_bd  chonbuoi" > 
