    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="showback"  style="background-color: white;">  
                <h2 style="text-align: center; color:blue"> <strong>ĐĂNG KÍ GIẢNG DẠY</strong></h2>
                <span id="session"> 
                    <?php
                    ...
                    <div class="row mt">
                        <div class="col-sm-12">
                            ...
                            <table>
                                ...
                                <button type="button" class="btn btn-primary tkb"  data-detail_semester_id="{{$oweek->detail_semester_id}}"  data-toggle="modal" data-target="#allki" style="float: right;background-color: blue;">Đăng kí phòng</button> 
                                    @endforeach
                                                                ...
                                                                @foreach ($all_room as $key=> $room)
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                         ...
                                                                         @if($buoi->id_buoi == 1)
                                                                         <button class="btn dangkyphong" data-toggle="modal" data-detail_semester_id="{{$week->detail_semester_id}}" data-id_room="{{($room->room_id)}}" data-id_buoi="{{($buoi->id_buoi)}}" data-id_thu="{{($thu->id_thu)}}" data-target="#Sang"> <i class="fa fa-calendar-plus-o" style="color:green">s</i> </button>
                                                                        @else   
                                                                        @if($buoi->id_buoi == 2)
                                                                        <button class="btn dangkyphong" data-toggle="modal" data-detail_semester_id="{{$week->detail_semester_id}}" data-id_room="{{($room->room_id)}}" data-id_buoi="{{($buoi->id_buoi)}}" data-id_thu="{{($thu->id_thu)}}" data-target="#Chieu"> <i class="fa fa-calendar-plus-o" style="color:green">c</i> </button>

                                                                        @else
                                                                        <button class="btn dangkyphong" data-toggle="modal" data-detail_semester_id="{{$week->detail_semester_id}}" data-id_room="{{($room->room_id)}}" data-id_buoi="{{($buoi->id_buoi)}}" data-id_thu="{{($thu->id_thu)}}" data-target="#Toi"> <i class="fa fa-calendar-plus-o" style="color:green">t</i> </button>
                                                                        @endif @endif
